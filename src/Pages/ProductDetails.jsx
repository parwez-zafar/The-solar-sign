    ...
    <div>
      <Container>
        ...
        >
          ...
          <Link style={styles.linkStyle} to='/'>Shop</Link>  &nbsp;{`>`}&nbsp;
          <Link style={styles.linkStyle} to='/'>Living</Link> &nbsp;{`>`}&nbsp;
          <Link style={styles.linkStyle} to='/'>Product</Link>
        </Typography>
          ...
          <Grid container spacing={5} style={{}}>
            <Grid item sm={12} xs={12} md={6} xl={6} style={{
              ...
              <Box style={{ position: 'relative' }}>
                ...
                <ArrowBackIcon fontSize="large" style={styles.forwardArrow}
                  onClick={() => { imgUrl == 0 ? setImgUrl(3) : setImgUrl(imgUrl - 1) }}
                />

                <img src={imgarr[imgUrl]} alt={"alt"} style={styles.img} />

                <ArrowForwardIcon
                  fontSize="large" style={styles.backwordArrow}
                  onClick={() => { imgUrl == 3 ? setImgUrl(0) : setImgUrl(imgUrl + 1) }}
                />
              </Box>

              <Box display={"flex"} alignItems={'center'} justifyContent={'space-between'} mb={5} >
                {/* multiple image */}
                <img src={src2} alt={"alt"} style={styles.anotherImg} onClick={() => setImgUrl(1)} />
                <img src={src3} alt={"alt"} style={styles.anotherImg} onClick={() => setImgUrl(2)} />
                <img src={src4} alt={"alt"} style={styles.anotherImg} onClick={() => setImgUrl(3)} />
              </Box>
            </Grid>
            ...
            <Grid item sm={12} xs={12} md={6} xl={6}>
              ...
              <Box sx={{ display: "flex", p: 2, fontFamily: "Inter" }}>
                <CustomButton wdth={"100%"} type="button">Add To Cart</CustomButton>
              </Box>
            </Grid>
          </Grid>
        </Box>
