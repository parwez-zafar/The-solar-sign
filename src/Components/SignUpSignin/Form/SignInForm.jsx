        ...
        >
            <form noValidate>
                <Stack spacing={{ xs: 2, sm: 1 }} width={{ xs: 200, sm: 400 }}>
                    ...
                    <Typography variant='subtitle1'> Don&apos;t have an account? <Link style={{ color: '#38CB89', textDecoration: 'none' }}>Sign Up</Link> </Typography>

                    <TextField variant='standard' label='your username or eamil address' type='text' />
